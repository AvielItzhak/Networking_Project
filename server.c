...
int main() {
    ...
    while (1) 
    {
        ...
        if (Req_msg_rec <= 0) {
         ...
         if (Req_msg_rec > 0) { // Print message received in bytes
        ...
        /* Request Handler - DELETE || UPLOAD || DOWNLOAD:
            ...
            * DOWNLOAD - Awaiting ACK and initiating DOWNLOAD sequence - Send packet, check Response
            * UPLOAD - Sending ACK to initiate UPLOAD sequence - get packet, send Response 
         */ 
        ...
        if (ClientRequest.CurOP_ID == UPLOAD)
        {
            ...
            FILE* Backup_Fpoint; // iterator traverse file

            snprintf(Backup_FilePATHinServer, Backup_FilePATHinServer_len, "%s/%s", BACKUP_Folder_NAME, ClientRequest.CurOP_FilePATH);

            // handles file with same name in server upload folder and assign different name
        ...
        if ( ClientRequest.CurOP_ID == DOWNLOAD )
        {
            ...
            // handleing client Response for initializing DOWNLOAD 
            ...
            Fpoint = fopen(ClientRequest.CurOP_FilePATH,"r"); // creating a pointer file to scan the intended file
            ...
            while (1) 
            {
                ...
                while (1) // ACK Check LOOP and Retransmission previous packet 
                {
                    ...
                    // handleing client Response for packet Transfer 
            ...
            // If reach here the DOWNLOAD was successful and Transfer completed 
